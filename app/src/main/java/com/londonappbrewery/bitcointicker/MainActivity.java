...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                String finalUrl = BASE_URL + adapterView.getItemAtPosition(position)+ ".json";
                Log.d(" Bitcoin ", " Final URL is:  " + finalUrl);
                selectedCurrency = adapterView.getItemAtPosition(position).toString();
                Log.d(" Bitcoin ", " Selected currency :  " + selectedCurrency);
    ...
    private void letsDoSomeNetworking(String url) {
        ...
        client.get(url, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    //String price = response.getString("rate");
                    JSONObject bpiObject = response.getJSONObject("bpi");
                    JSONObject obj = bpiObject.getJSONObject(selectedCurrency);
                    String price = obj.getString("rate");
    ...
    }//----------- END method letsDoSomeNetworking(...) -----------
